...
@Retention(RUNTIME)
@Constraint(validatedBy = { FieldsDiversityValidator.class })
public @interface FieldsDiversity {
...
class FieldsDiversityValidator implements ConstraintValidator<FieldsDiversity, Object> {
    ...
    @Override
    public void initialize(FieldsDiversity constraintAnnotation) {
